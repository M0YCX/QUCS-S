...
<Properties>
  <View=0,21,1406,1426,1,0,0>
  <Grid=10,10,1>
  <DataSet=D20221112_70MHz_RF_Preselector_TB.dat>
  <DataDisplay=D20221112_70MHz_RF_Preselector_TB.dpl>
  <OpenDisplay=1>
  <Script=D20221112_70MHz_RF_Preselector_TB.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <NutmegEq NutmegEq2 1 1140 420 -31 16 0 0 "ac" 1 "gaindb=db(v(out)/v(in))" 1>
  <Vac V1 1 350 270 18 -26 0 1 "10 mV" 1 "70 MHz" 1 "0" 0 "0" 0>
  <Vac V2 1 1000 740 31 -40 1 1 "1 V" 1 "70 MHz" 1 "0" 0 "0" 0>
  <Sub SUB1 1 730 260 -26 48 0 0 "/home/bev/Documents/Radio/QUCS-S/Studies/0900_RF_Preamps_Preselectors/D20221112_70MHz_RF_Preselector.sch" 0>
  <Sub SUB2 1 740 710 -26 48 0 0 "/home/bev/Documents/Radio/QUCS-S/Studies/0900_RF_Preamps_Preselectors/D20221112_70MHz_RF_Preselector.sch" 0>
</Components>
<Wires>
  <420 130 420 230 "" 0 0 0 "">
  <920 130 920 230 "" 0 0 0 "">
  <920 230 970 230 "out" 980 200 24 "">
